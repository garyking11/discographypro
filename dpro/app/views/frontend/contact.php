        ...
        <section id="section-two">
            <div class="container">
                ...
                <div class="row clearfix">
                 ...
                 <div class="span6">
								 <?php include __DIR__ . '/../../../../' . APPLICATION_PATH . '/plugins/ajax-mailer/form.php'; ?>
                         
                </div><!-- end span -->                          
                <div class="span6">                    
                    <ul class="nobullet">
                    <li><i class="icon-envelope-alt"></i> <a href="#">Contact Support</a></li>
                    <li><i class="icon-list-alt"></i> <a href="#">Wish List/Suggestions</a></li>
                    <li><i class="icon-check"></i> <a href="#">Sales</a></li>
                    </ul>
                </div> 
