...
<div id="slideshow-images">
    <div class="row-fluid">
        <div class="span6">
            ...
            <!--<div id="image-accounts" class="bg-gray"> -->
        ...
        <div class="span6">
            ...
            <a class="btn" id="upload-album-images" href="#data" >Upload an album image</a>
       ...
       <p><a class="btn" id="add-image">ADD SELECTED IMAGE T0 SLIDESHOW</a></p>
